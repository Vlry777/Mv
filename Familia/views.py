...
def create_family_memebers(request,name,surname,age,dni,alive):
    create_familiar= Family.objects.create(name = name, surname = surname,
     age = age, dni= dni, alive= alive)
